...
$mail = new PHPMailer(true);                              // Passing `true` enables exceptions
    try {
        ...
        {
            $status = '<div style="text-align: center; background-color:#DCEFD4; border:1px solid; border-color:#D2E7C0;color: #3B6E38; padding: 10px; width: 50% !important; border-radius: 5px; margin:10px">Reviewed</div>';
        }else{
