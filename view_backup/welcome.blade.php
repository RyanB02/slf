...
@endsection
@section('meta')
    <meta name="description" content="Saddleworth Literary Festivals official site">
@endsection
...
<html>
    <body>
        ...
        @endif
        background-size:155%;  margin-top: -25px !important">
        ...
        <div style=" border-radius: 0 !important; text-align: center; padding-top: 0px; margin-top: 0px">
            @include('tickets')
...
<div class="container-flex mt-1">
        <div class="alert alert-info draw mb-1" style="text-align: center; margin-bottom: 0px; border-radius: 0px">
            The Mayor of Oldham is opening the Literary Festival on Saturday 24th March at 11:15am
        </div>
         <div class="row" style="padding: 0px !important; margin:0px !important">
                <div class="col-6" style="padding:0px !important">
                    <div class="card card-default bg-light text-dark ero" style="border-radius:0px !important; height:160px !important;  color:#5B6265;  margin:0px !important; padding:0px; width:100%">
                        <center>
                            <br>
                            <h1 style="font-size:50px" class="mb-3"> <?php echo $days_remaining; ?> </h1>
                            <h4>Days till festival! </h4> 
                        </center>
                    </div>
                </div>

            <a  href="{{route('schedule')}}" style="cursor: pointer; text-decoration: none;padding:0px !important " id="about_circ" class="col-6"> 
                <div style="padding-left:0px  !important ">
                    <div class="card card-default bg-light text-dark ero" style="border-radius:0px !important; height:160px !important;  color:#5B6265">
                        <div class="card-body animated pulse">
                            <center>
                                <i class="fa fa-clock-o fa-5x mb-2" aria-hidden="true" ></i>
                                <h4>Schedule {{config('app.next_festival_year')}}</h4>
                            </center>
                        </div>
                    </div>
                </div>
        ...
        <div class="row" style="padding: 0px !important; margin:0px !important">
            ...
            <a  href="{{route('about')}}" style="cursor: pointer; text-decoration: none; margin:0px !important ; padding:0px !important" id="about_circ" class="col-6"> 

                <div class="" style="">
                    <div class="card card-default bg-light text-dark ero" style="border-radius:0px !important; height:160px !important;  color:#5B6265;  margin:0px !important; padding:0px; width:100%">
                        <center>
                            <br>
                            <i class="fa fa-info fa-5x mb-2" aria-hidden="true"></i>
                            <h4>About Us
                            </h4> 
                        </center>
                    </div>
            ...
            <a href="{{route('upcoming')}}" style="cursor: pointer; text-decoration: none; padding:0px !important" id="about_circ" class="col-6"> 
                <div class="" style="">
                    <div class="card card-default bg-light text-dark ero" style="border-radius:0px !important; height:160px !important;  color:#5B6265; border-">
                        <div class="card-body">
                            <center>
                                <i class="fa fa-calendar fa-5x mb-2" aria-hidden="true" ></i>
        ...
        <div class="row" style="padding: 0px !important; margin:0px !important">
            <a  href="{{route('guests')}}" style="cursor: pointer; text-decoration: none;padding:0px !important" id="about_circ" class="col-6"> 
                <div class="" style="">
                    <div class="card card-default bg-light text-dark ero" style="border-radius:0px !important; height:160px !important; color:#5B6265">
                        <div class="card-body">
                            <center>
                                <i class="fa fa-address-book fa-5x mb-2" aria-hidden="true" ></i>
            ...
            <a  href="{{route('featuring')}}" style="cursor: pointer; text-decoration: none;padding:0px !important" id="about_circ" class="col-6"> 
                <div class="" style=" ">
                    <div class="card card-default bg-light text-dark ero" style="border-radius:0px !important; height:160px !important; color:#5B6265">
                        <div class="card-body">
                            <center>
                                <i class="fa fa-star fa-5x mb-2" aria-hidden="true" ></i>
                                <h4>Featuring</h4>
                            </center>
                        </div>
                    </div>
        ...
        <div class="row" style="padding: 0px !important; margin:0px !important">
            <a href="#" data-toggle="modal" data-target="#SubmitModalMobile" style="cursor: pointer; text-decoration: none; padding:0px !important" id="about_circ" class="col-6"> 
                <div class="" style="">
                    <div class="card card-default bg-light text-dark ero" style="border-radius:0px !important; height:160px !important;  color:#5B6265; border-">
                        <div class="card-body">
                            <center>
                                <i class="fa fa-pencil fa-5x mb-2" aria-hidden="true"></i>
                                <h4>Submit Piece Of Writing</h4>
                            </center>
                        </div>
                    </div>
                </div>
            </a>
            <a  href="#"  data-toggle="modal" data-target="#PoetryCompModalMobile" style="cursor: pointer;padding:0px !important; background-color:#FE561C" id="about_circ" class="col-6"> 
                <center>
                        <img src="{{asset('images/poetry_comp.PNG')}}"  style="height:160px">
                </center>
            </a>
        </div>
    </div>
        ...
        <div id="SubmitModalMobile" class="modal fade" role="dialog" style="background-color: rgba(0,0,0,0.96); width: 100%">
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <div class="row col-12">
                        <div class="col-xs-5">
                            <img src="{{asset('/uploads/writers-speakers/1509462446.jpg')}}" style="border-radius: 10px; width:90%">
    ...
    <div id="PoetryCompModalMobile" class="modal fade" role="dialog" style="background-color: rgba(0,0,0,0.96);">
        <div class="modal-dialog modal-lg" >
            <div class="modal-content" st>
              <div class="modal-body" style="padding: 0px; margin:0px;">
                <img src="{{asset('images/poetry_comp_full.png')}}" style="width:100%;border-top-right-radius:5px;border-top-left-radius:5px; ">
