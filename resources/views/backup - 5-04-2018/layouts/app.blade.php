        ...
        @if(Auth::user())
            @if(Auth::user()->admin == 1)
                ...
                <div class="d-xl-none d-lg-none ">
                    @yield('scroll')
                    @include('layouts.partials.nav')
                    <div class="alert alert-info" style="border-radius: 0px; margin-top: 10%; text-align: center">
                        We will be back soon, we are just updating a few things.<br>
                        You can still contact us by tapping the little mail icon, on the right side of your screen.<br>
                        We thank you for your support.
                        <hr>
                        Expected finish date: 22nd June 2018
                    </div>
                    @if(Auth::user() and Auth::user()->admin == 1)
                    ...
                    <div class="container">
                        ...
                        <div class="card card-default">
                            ...
                            <div class="card-body" style="text-align: center">
                                Saddleworth Literary Festival is currently in maintenance mode, we are updating a few things under the hood..
                                <br>
        ...
        @else
            ...
            <div class="container " style="margin-top: 10%">
                <div class="card card-default" style="border: 2px solid; border-color: #CF2941; border-radius: 5px ">
                    ...
                    <div class="card-body" style="text-align: center">
                        Saddleworth Literary Festival is currently in maintenance mode, we are updating a few things under the hood., we are updating a few things under the hood.
                        <br>
                        We appologise for the inconvenience, we should be back soon
                        <hr>
                       ...
                       var alerted = localStorage.getItem(\'alerted\') || \'\';
                        if (alerted != \'yes\') {
                         swal({
                          ...
                          text: "Come down to Saddleworth School for day one of the Saddleworth Literary Festival",
                          icon: "info",
                    ...
                    <script>
                       var alerted = localStorage.getItem(\'alerted2\') || \'\';
                        if (alerted != \'yes\') {
                         swal({
                          title: "Today is the Day!",
                          text: "Come down to Saddleworth School for day two of the Saddleworth Literary Festival",
                          icon: "info",
                          closeOnClickOutside: false,
                          closeOnEsc: false,
                          button:"Close",
