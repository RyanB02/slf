...
@section('content_desktop_render_admin')
	...
	<div class="container">
		...
		<div class="card card-default">
			...
			<div class="card-body">
				<form class="form-vertical" role="form" method="post" action="{{route('admin_add_featuring_add')}}" enctype="multipart/form-data">
					<div class="form-group">
						<label for="sponsor_name">Guest Name  <a style="color:red; font-size: 20px; font-family: comic-sans; text-decoration: none ">*</a></label>
					...
					<div class="form-group">
						<label for="attendee_name" >Guest image <a style="color:red; font-size: 20px; font-family: comic-sans; text-decoration: none">*</a> </label>
